...
"First, I create a new string by removing all non-alphanumeric characters
and converting everything to lowercase.
Then I compare the cleaned string with its reverse.
 If both are equal, it's a palindrome; otherwise, it is not."
